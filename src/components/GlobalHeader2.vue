...
<template>
  ...
  <div v-if="id">
    <footer class="text-gray-600 body-font">
      <div
        class="container px-20 fixed bottom-0 pt-10 mx-auto flex items-center sm:flex-row flex-col"
      >
        <!-- <a
      ...
      >
        ...
        <p
          class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4"
        >
          © 2020 Tailblocks —
          <a
