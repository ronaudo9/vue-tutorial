...
export default {
  ...
  methods: {
    ...
    customer() {
      ...
      axios.get("http://localhost:8001/users/" + id).then((response) => {
    ...
    transition() {
      ...
      values.forEach((value) => {
        ...
        axios
          .delete("http://localhost:8001/purchase/" + id)
          .then((response) => {
    ...
    history() {
      ...
      this.products.forEach((value) => {
        ...
        axios
          .post("http://localhost:8001/purchasesHistory", values)
          .then((response) => {
        ...
        axios
          .patch("http://localhost:8001/carts/" + id, {
            deleted: true,
          })
          .then((response) => {
        ...
        axios
          .patch("http://localhost:8001/purchase/" + id, {
            deleted: true,
          })
          .then((response) => {
            let data = response.data;
